...
import (
	...
	tests "test.com/excel-ark/internals/tests/test_cases"
)

//TO run: go test -run TestLoadExcelSheet -v
//TO run (in root dir): go test ./internals/tests/. -v
...
func TestGetParameters(t *testing.T) {
	...
	internals.PredeclaredDict["TEST_getParametersLoad_excel_sheet"] =
		starlark.NewBuiltin("TEST_getParametersLoad_excel_sheet",
			tests.MOCK_getParametersLoad_excel_sheet)
	globals := internals.ExecStarlarkFile("./test_cases/query_load_excel.star")
